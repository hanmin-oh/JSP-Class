...
<!-- 일정 시간이 경과되면 특정 웹 사이트로 이동하기 <meta http-equiv="refresh" content="5; url='https://www.naver.com'"> -->
<!-- 일정 시간이 경과되면 현재 페이지를 다시 호출한다. .. 새로고침 -->
...
%>
<table border="1" width="40%" align="center" cellspacing="0" cellpadding="5">
	<tr> 
		<th colspan="2"> 
		<%= poll.get(0) %>
		</th> 
 ...
 %>		
 	<tr>
		<td width="100">
			...
			<!-- 득표율 서식 지정 (<%=df2.format(per)%>)  -->
		</td>
		<td>
			<hr size="10" color="#58D3F7" width="<%=400 * per%>" align="left">
		</td>
<% 
	}
%>
