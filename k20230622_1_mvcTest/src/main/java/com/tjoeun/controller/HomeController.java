...
// 브라우저의 주소창에 contentPath("/k20230622_1_mvcTest") 뒤에 @WebServlet 어노테이션에 인수로 지정된 요청("/HomeController")이 들어오면
// @WebServlet 어노테이션이 붙어있는 클래스(컨트롤러)에서 get 방식의 요청이 들어오면 doGet() 메소드가 자동으로 실행되고 post 방식의 요청이 
