    ...
    <table class="table1" width="99%" border="1" align="center" cellpadding="5" cellspacing="0">
        ...
        <tr>
            <td>
                ...
                <c:set var="name" value="${fn:replace(vo.name, '>' , '&gt;')}"></c:set>
                <input type="hidden" name="name" value="${vo.name}">${fn:trim(vo.name)}(${vo.ip})님이
                ...
                에 남긴 글
                <br/>
                    <textarea rows="10" name="memo" style="resize: none; width: 99%;">
                        <c:set var="memo" value="${fn:replace(fn:trim(vo.memo), '<' , '&lt;')}"></c:set>
