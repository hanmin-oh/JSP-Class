...
public class DBUtil {
    ...
    public static Connection getCommonsDBCPConnection() {
        Connection conn = null;
        try {
            Class.forName("oracle.jdbc.driver.OracleDriver"); // mysql 5.x
    ...
    public static Connection tomcatDBCPConnection() {
    //	tomcatDBCP 사용해서 mysql 이나 oracle에 연결하는 Connection을 리턴하는 메소드
    Connection conn = null;
    try {
