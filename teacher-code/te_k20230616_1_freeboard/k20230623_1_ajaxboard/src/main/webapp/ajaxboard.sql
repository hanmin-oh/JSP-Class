...
insert into ajax (idx, name, age, gender, email) values (ajax_idx_seq.nextval, '우마왕', 20, '남자', 'a@a.com');
insert into ajax (idx, name, age, gender, email) values (ajax_idx_seq.nextval, '계왕신', 20, '남자', 'a@a.com');
