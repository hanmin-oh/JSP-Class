...
request.setCharacterEncoding("UTF-8");
	...
	// hasMoreElements() : Enumeration 인터페이스 객체에 저장된 다음 데이터가 있으면 true, 없으면 false를 
	// 리턴시킨다. 
	...
	continue;
		...
		//업로드 제한
		File realFilename = new File("C:/upload/" + filename);
	...
	out.println("</script>");
	out.println("업로드(저장)된 파일 이름 : " + filename + "<br/>");
	out.println("업로드(저장)된 파일 크기 : " + fileLength + "<br/>");
