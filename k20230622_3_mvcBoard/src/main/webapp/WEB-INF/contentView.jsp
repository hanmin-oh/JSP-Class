		...
		<tr>
			<td colspan="4" align="center">
				...
				<input type="button" value="삭제하기" 
					onclick="location.href='delete.ohm?idx=${vo.idx}&currentPage=${currentPage}'"/>
				<input type="button" value="답변하기" 
					onclick="location.href='reply.ohm?idx=${vo.idx}&currentPage=${currentPage}'"/>
				<input type="button" value="돌아가기" 
					onclick="location.href='list.ohm?currentPage=${currentPage}'"/>
			</td>
		</tr>
	</table>
