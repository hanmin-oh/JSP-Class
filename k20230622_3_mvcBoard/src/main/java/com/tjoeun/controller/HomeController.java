	...
	protected void actionDo(HttpServletRequest request, HttpServletResponse response)
		...
		switch (context) {
			case "/insert.ohm":
				...
				break;
			case "/insertOK.ohm":
				  /* insert.jsp에서 테이블에 저장할 메인글 정보를 입력하고 submit 버튼을 클릭하면 폼에 입력한 정보가 컨트롤러의 doPost()
				  메소드의 HttpServletRequest 인터페이스 타입의 객체인 request에 저장된다. doPost() 메소드 request에 저장된 데이터를 
				  가지고 actionDo() 메소드를 실행하므로 insert.jsp에 입력한 메인글 정보는 actionDo() 메소드의 request에 저장된다.  */
