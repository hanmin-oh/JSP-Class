...
<%--
    ...
    입력된 데이터가 정상적인 데이터인가 유효성을 검사해서 검사 결과가 정상이면 true, 오류가 발생되면 false를
    리턴하게 만든다. => 기본값은 true
     - onsubmit="return javascript함수(this)" 형태로 코딩하며 javscript 함수의 실행 결과 return 값이 true면
--%>
...
<form action="juminFormOk.jsp" method="post" name="juminForm" onsubmit="return formCheck(this)">
    ...
    <input type="submit" name="sendBtn" value="검사하기" onsubmit="formCheck(this)"/>
</form>
