		...
		<table class="table table-hover table-bordered" style="border: 1px solid black;">
			...
			<tbody>
				<tr>
					...
					<td>
						<button id="userID" class="form-control" type="button" onclick="registerCheckFunction()">
							중복검사
						</button>
					</td>
				</tr>
				<tr>
					...
					<!-- ID 중복 검사 결과 메시지가 출력될 영역 -->
						<h5 id="idCheckMessage1" style="color: blue; font-weight: bold;"></h5>
						<h5 id="idCheckMessage2" style="color: red; font-weight: bold;"></h5>
					</td>
				</tr>
				<tr>
					<th class="primary">
...
<!-- 현재 프로젝트는 session을 사용하지 않기 때문에 모든 스크립트 릿을 삭제해야 한다. -->
